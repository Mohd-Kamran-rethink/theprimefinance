                ...
                <aside class="sidebar">
                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="current"><a href="{{url('business-loan')}}">Business Loan<i
                                            class="fa fa-angle-right"></i></a></li>
                                <li><a href="{{url('Equipment-Machinery')}}">Equipment &amp; Machinery<i
                                            class="fa fa-angle-right"></i></a></li>
                    ...
                    <div class="sidebar-widget-two contact-info-widget">
                        <div class="inner-box" style="background-image: url(assets/images/background/image-18.jpg);">
                            <h3>Need Help?</h3>
                            <ul>
                                <li><a href="mailto:info@theprimefinance.com">info@theprimefinance.com</a></li>
